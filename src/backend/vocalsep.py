...
class VocalSeparation:
    ...
    def separate_audio(self, filepath: str, split=True, device="cuda" if torch.cuda.is_available() else "cpu", avg_method='weighted_median') -> None:
        ...
        # region ensemble mode to mix two models into one

...
- Can auto-detect what song is currently playing in Spotify (Uses API Key)
...
- Song lyrics are force-aligned using [lyric-align](https://github.com/ijuinryukichi/lyric-align)
...
## Flowchart
This diagram shows how the program functions (outdated):
